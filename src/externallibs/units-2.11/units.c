...
const char *unitsfiles[MAXFILES+1];   /* Null terminated list of units file names */
...
{
   static struct unittype have, want;
   const char *havestr=0, *wantstr=0;
   int readerr;
   char **unitfileptr;
   int unitcount=0, prefixcount=0, funccount=0;   /* for counting units */
   char *queryhave, *querywant;
